...
export default function SignupPage() {
  ...
  return (
    <div className='flex w-screen h-screen overflow-hidden bg-white'>
      ...
      <div className='w-full md:w-1/2 flex items-center justify-center p-4 order-2 md:order-1 relative'>
        ...
        <div className='w-full max-w-md relative z-10 px-4'>
          <Card className='shadow-xl border border-gray-100 bg-white/80 backdrop-blur-md relative overflow-hidden rounded-2xl'>
            ...
            <CardHeader className='space-y-3 pb-3 relative z-10'>
              ...
              <CardDescription className='text-center text-sm'>Start managing your institution today</CardDescription>
            </CardHeader>
            ...
            <CardContent className='space-y-4 relative z-10 px-6 backdrop-blur-sm'>
              ...
              <div className='text-center text-sm text-gray-600 pt-2'>
                ...
                <Link href='/login' className='text-primary font-medium hover:underline hover:text-primary/80 active:text-primary/70 cursor-pointer'>
                  Sign in
                </Link>
              </div>
            </CardContent>
